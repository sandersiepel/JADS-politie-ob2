...
end_date = "2022-07-25"  # End date is INclusive!
...
heatmap_begin_date = "2022-07-14"
heatmap_end_date = "2022-07-24"  # End date is INclusive! Choose a date that lies (preferably 2 days) before end_date to avoid errors. 
