...
end_date = "2015-12-31"  # End date is INclusive! 
...
horizon_size = 30
window_step_size = 1
outputs_folder_name = f"mattanja1-{training_window_size}-{horizon_size}-{window_step_size}" # All of the outputs will be placed in output/outputs_folder_name
